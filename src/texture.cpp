...
void ImageTexture::set_tex_params()
{
...
unsigned int ImageTexture::create_texture(unsigned int width, unsigned int height, int internal_format, int format)
{
    unsigned int id;
    glGenTextures(1, &id);
...
void ImageTexture::load(std::string path, bool srgb)
{
